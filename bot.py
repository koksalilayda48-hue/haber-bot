...
API_ID = int(os.environ.get("API_ID", 33397779))
API_HASH = os.environ.get("API_HASH", "b253283cd2c3df8d7187c85850b918ae")

# Bot token
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8062154104:AAHKYLzFRbZ8EiRhm7zPJsYqQitHmcUEqWA")
